...
if (makePlot) {
    ...
    CO2=rio::import('https://github.com/mchevalier2/Papers/raw/master/Chevalier_etal_MD962048/data/IndependentRecords.xlsx', which=7)[62:1883,c(4,2)]
    CO2=read.xlsx('/Users/mchevali1/GitHub/Papers/2019_Chevalier et al., QSR, MD96-2048/data/Data_Fig4.xlsx', sheet='CO2')


    ECC=read.xlsx('/Users/mchevali1/GitHub/Papers/2019_Chevalier et al., QSR, MD96-2048/data/Data_Fig4.xlsx', sheet='Eccentricity')[1:800,c(1,2)]
    DomeC=read.xlsx('/Users/mchevali1/GitHub/Papers/2019_Chevalier et al., QSR, MD96-2048/data/Data_Fig4.xlsx', sheet='DomeC')[1:5784,c(1,2)]
    SSTs=read.xlsx('/Users/mchevali1/GitHub/Papers/2019_Chevalier et al., QSR, MD96-2048/data/Data_Fig4.xlsx', sheet='SSTs')[1:306, c(20, 21)]
    LR04=read.xlsx('/Users/mchevali1/GitHub/Papers/2019_Chevalier et al., QSR, MD96-2048/data/Data_Fig4.xlsx', sheet='LR04')[1:701,c(1,2)]

    POLLENSUM=read.xlsx('/Users/mchevali1/GitHub/Papers/2019_Chevalier et al., QSR, MD96-2048/data/Data_Fig4.xlsx', sheet='Pollen')[1:181,c(1,2,3)]
    POLLENTAXA=apply(ifelse(read.xlsx('/Users/mchevali1/GitHub/Papers/2019_Chevalier et al., QSR, MD96-2048/data/Data_Fig4.xlsx', sheet='Pollen')[1:181,-c(1,2,3,219,220)]>0,1,0),1,sum)
    ...
    DomeC.smooth=gausmooth(DomeC, XX.interp, mean(diff(xx)))
    CO2.smooth=gausmooth(CO2, XX.interp, mean(diff(xx)))
    #SSTs=read.xlsx('/Users/mchevali1/GitHub/Papers/2019_Chevalier et al., QSR, MD96-2048/data/Data_Fig4.xlsx', sheet='SSTs')[1:305, c(14, 16)]
    SSTs.smooth=gausmooth(SSTs, XX.interp, mean(diff(xx)))
    Pollen.PCA=read.xlsx('/Users/mchevali1/GitHub/Papers/2019_Chevalier et al., QSR, MD96-2048/data/Data_Fig4.xlsx', sheet='Pollen_PCA')[,c(6,8)]
    Pollen.PCA.smooth=gausmooth(Pollen.PCA, XX.interp, mean(diff(xx)))
    POLLEN.percent=cbind(POLLEN[,1], POLLEN[,-1]/apply(POLLEN[,-1], 1, sum))
    MALAWI=read.xlsx('/Users/mchevali1/GitHub/Papers/2019_Chevalier et al., QSR, MD96-2048/data/Data_Fig4.xlsx', sheet='Malawi')[1:295,c(1,3)]
    MALAWI.smooth=gausmooth(MALAWI, XX.interp, mean(diff(xx)))
    LR04.smooth=gausmooth(LR04, XX.interp, mean(diff(xx)))
    LEAFWAX=read.xlsx('/Users/mchevali1/GitHub/Papers/2019_Chevalier et al., QSR, MD96-2048/data/Data_Fig4.xlsx', sheet='Leaf wax')[1:177,c(1,10)]
    LEAFWAX.detrended=cbind(LEAFWAX[,1], LEAFWAX[,2] - LEAFWAX[,1]*coef(lm(LEAFWAX[,2]~ LEAFWAX[,1]))[2] - coef(lm(LEAFWAX[,2]~ LEAFWAX[,1]))[1])
    LEAFWAX.smooth=gausmooth(LEAFWAX.detrended, XX.interp, mean(diff(xx)))
    ...
    DomeC.ysmooth2=gausmooth(DomeC[,c(1,2)], PANN[,1], mean(diff(PANN[,1])))
    ...
    pdf("/Users/mchevali1/Manuscripts/Chevalier et al., MD96-2048/figs/Fig4_v3.pdf", width=3.54, height=9.45, useDingbats=FALSE)  ;  {
      ...
      plot.window(xlim=c(-150,950),ylim=c(-5,55)+60*c(-4,1.4)+60*c(-6.4*0.025, 6.4*0.025),main='',ylab='',xlab='')  ;  {
        ...
        points(PANN[,1], DMG*5, col='grey20', type='l', lwd=1.2)
      ...
      #plot.window(xlim=c(-100, 900),ylim=c(-3,3)+c(-6,21)+c(-0.825, 0.825),main='',ylab='',xlab='')  ;  {
      COL='black'
      ...
      plot.window(xlim=c(-150,950),ylim=c(16.9,21)+4.1*c(-2,3.4)+4.1*c(-6.4*0.025, 6.4*0.025),main='',ylab='',xlab='')  ;  {
        COL='black'
        points(PANN, col=makeTransparent('grey70', alpha=1), type='l', cex=0.3)
        points(XX.interp, PANN.ysmooth, lwd=1.2, col='darkorchid3', type='l')
